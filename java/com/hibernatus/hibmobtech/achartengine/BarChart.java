...
/**
 * The bar com.bleau.hibernatus.mob.achartengine.chart rendering class.
 */
public class BarChart extends XYChart {
  ...
  /**
   * The bar com.bleau.hibernatus.mob.achartengine.chart type enum.
   */
  public enum Type {
  ...
  /**
   * Builds a new bar com.bleau.hibernatus.mob.achartengine.chart instance.
   * 
   * @param dataset the multiple series dataset
   * @param renderer the multiple series com.bleau.hibernatus.mob.achartengine.chart.renderer
   * @param type the bar com.bleau.hibernatus.mob.achartengine.chart type
   */
