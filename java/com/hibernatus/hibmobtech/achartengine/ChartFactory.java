...
import com.hibernatus.hibmobtech.achartengine.BarChart.Type;
import com.hibernatus.hibmobtech.achartengine.CombinedXYChart.XYCombinedChartDef;
import com.hibernatus.hibmobtech.model.CategorySeries;
import com.hibernatus.hibmobtech.model.MultipleCategorySeries;
...
public class ChartFactory {
    ...
    public static final String CHART = "com.bleau.hibernatus.achartengine";
    public static final String TAG = ChartFactory.class.getSimpleName();
     ...
     * @param renderer the multiple series chart.renderer (cannot be null)
     * @return a line chart graphical view
     * @throws IllegalArgumentException if dataset is null or chart.renderer is null or
     *           if the dataset and the chart.renderer don't include the same number of
     *           series
     */
     ...
     * @param renderer the series chart.renderer (cannot be null)
    ...
    public static final GraphicalView getPieChartView(Context context, CategorySeries dataset,
        ...
        Log.d(TAG, "getPieChartView: dataset=" + dataset + " renderer=" + renderer);
     ...
     * @param context the context
     * @param dataset the category series dataset (cannot be null)
     * @param renderer the dial chart.renderer (cannot be null)
     * @return a pie chart view
     * @throws IllegalArgumentException if dataset is null or chart.renderer is null or
     *           if the dataset number of items is different than the number of
     *           series renderers
    ...
    /**
     * Checks the validity of the dataset and chart.renderer parameters.
     *
     * @param dataset the multiple series dataset (cannot be null)
     * @param renderer the multiple series chart.renderer (cannot be null)
     * @throws IllegalArgumentException if dataset is null or chart.renderer is null or
    ...
    private static void checkParameters(XYMultipleSeriesDataset dataset,
        ...
        if (dataset == null || renderer == null
            ...
            throw new IllegalArgumentException(
                    "Dataset and chart.renderer should be not null and should have the same number of series");
        }
    }
    ...
    private static void checkParameters(CategorySeries dataset, DefaultRenderer renderer) {
        if (dataset == null || renderer == null
            ...
            throw new IllegalArgumentException(
                    "Dataset and chart.renderer should be not null and the dataset number of items should be equal to the number of series renderers");
        }
    }
