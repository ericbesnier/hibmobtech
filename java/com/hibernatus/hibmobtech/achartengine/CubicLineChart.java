...
/**
 * The interpolated (cubic) line com.bleau.hibernatus.mob.achartengine.chart rendering class.
 */
public class CubicLineChart extends LineChart {
  ...
  /**
   * Builds a cubic line com.bleau.hibernatus.mob.achartengine.chart.
   * 
   * @param dataset the dataset
   * @param renderer the com.bleau.hibernatus.mob.achartengine.chart.renderer
