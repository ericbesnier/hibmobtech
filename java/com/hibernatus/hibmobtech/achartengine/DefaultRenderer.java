...
public class DefaultRenderer implements Serializable {
    ...
    /** title text size. */
    private float mChartTitleTextSize = 60;
    /** A no color constant. */
    ...
    /** A text font for regular text, like the  labels. */
    ...
    private int mTextTypefaceStyle = Typeface.BOLD;
    ...
    private float mLabelsTextSize = 50;
...
*/
    ...
    /** A value to be used for scaling the  */
    ...
    /** If the  should display the values (available for pie ). */
    private boolean mDisplayValues;
    /** If the  should display the legends (available for pie ). */
    private boolean mDisplayLegend;
    /** The  values format. */
    private NumberFormat mChartValuesFormat;

    /**
     * A flag to be set if the  is inside a scroll and doesn't need to shrink
    ...
    /**
     * Returns the  title text size.
     *
     * @return the  title text size
     */
    ...
    /**
     * Returns the value to be used for scaling the
     *
    ...
    /**
     * Returns the original value to be used for scaling the
     *
    ...
    /**
     * Sets the value to be used for scaling the  It works on some charts
    ...
    /**
     * Returns if the  is inside a scroll view and doesn't need to shrink.
     *
    ...
    /**
     * To be set if the  is inside a scroll view and doesn't need to shrink
     * when not enough space.
     *
    ...
    /**
     * Returns the number format for displaying  values.
     *
     * @return the number format for  values
     */
     ...
     *
     * @param format the number format for  values
     */
    ...
    public boolean isDisplayLegend() {
        return mDisplayLegend;
    }

    public void setDisplayLegend(boolean mDisplayLegend) {
        this.mDisplayLegend = mDisplayLegend;
    }
}
