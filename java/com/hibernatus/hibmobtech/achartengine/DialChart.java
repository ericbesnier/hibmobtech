...
import com.hibernatus.hibmobtech.achartengine.DialRenderer.Type;
import com.hibernatus.hibmobtech.model.CategorySeries;
import com.hibernatus.hibmobtech.utils.MathHelper;

/**
 * The dial com.bleau.hibernatus.mob.achartengine.chart rendering class.
 */
public class DialChart extends RoundChart {
  /** The radius of the needle. */
  private static final int NEEDLE_RADIUS = 10;
  /** The series com.bleau.hibernatus.mob.achartengine.chart.renderer. */
  private DialRenderer mRenderer;

  /**
   * Builds a new dial com.bleau.hibernatus.mob.achartengine.chart instance.
   * 
   * @param dataset the series dataset
   * @param renderer the dial com.bleau.hibernatus.mob.achartengine.chart.renderer
   */
  ...
  /**
   * The graphical representation of the dial com.bleau.hibernatus.mob.achartengine.chart.
   * 
  ...
  /**
   * Returns the angle for a specific com.bleau.hibernatus.mob.achartengine.chart value.
   * 
   * @param value the com.bleau.hibernatus.mob.achartengine.chart value
   * @param minAngle the minimum com.bleau.hibernatus.mob.achartengine.chart angle value
   * @param maxAngle the maximum com.bleau.hibernatus.mob.achartengine.chart angle value
   * @param min the minimum com.bleau.hibernatus.mob.achartengine.chart value
   * @param max the maximum com.bleau.hibernatus.mob.achartengine.chart value
   * @return the angle
   */
  ...
  /**
   * Draws the com.bleau.hibernatus.mob.achartengine.chart tick lines.
   * 
