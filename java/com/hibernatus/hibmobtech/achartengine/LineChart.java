...
import com.hibernatus.hibmobtech.achartengine.XYSeriesRenderer.FillOutsideLine;
...
/**
 * The line com.bleau.hibernatus.mob.achartengine.chart rendering class.
 */
public class LineChart extends XYChart {
  /** The constant to identify this com.bleau.hibernatus.mob.achartengine.chart type. */
  public static final String TYPE = "Line";
  /** The legend shape width. */
  private static final int SHAPE_WIDTH = 30;
  /** The scatter com.bleau.hibernatus.mob.achartengine.chart to be used to draw the data points. */
  ...
  /**
   * Builds a new line com.bleau.hibernatus.mob.achartengine.chart instance.
   * 
  ...
  /**
   * Sets the series and the com.bleau.hibernatus.mob.achartengine.chart.renderer.
   * 
