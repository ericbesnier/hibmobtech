...
public class PieMapper implements Serializable {
  public static final String TAG = PieMapper.class.getSimpleName();
  ...
  /**
   * Fetches angle relative to pie com.bleau.hibernatus.mob.achartengine.chart center point where 3 O'Clock is 0 and
