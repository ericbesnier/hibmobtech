...
/**
 * The range bar com.bleau.hibernatus.mob.achartengine.chart rendering class.
 */
public class RangeBarChart extends BarChart {
  ...
  /**
   * Builds a new range bar com.bleau.hibernatus.mob.achartengine.chart instance.
   * 
   * @param dataset the multiple series dataset
   * @param renderer the multiple series com.bleau.hibernatus.mob.achartengine.chart.renderer
   * @param type the range bar com.bleau.hibernatus.mob.achartengine.chart type
   */
