...
/**
 * The XY com.bleau.hibernatus.mob.achartengine.chart rendering class.
 */
public abstract class XYChart extends AbstractChart {
  /** The multiple series dataset. */
  protected XYMultipleSeriesDataset mDataset;
  /** The multiple series com.bleau.hibernatus.mob.achartengine.chart.renderer. */
  ...
  /** The visible com.bleau.hibernatus.mob.achartengine.chart area, in screen coordinates. */
  ...
  /**
   * Builds a new XY com.bleau.hibernatus.mob.achartengine.chart instance.
   * 
  ...
  /**
   * The graphical representation of the XY com.bleau.hibernatus.mob.achartengine.chart.
   * 
   ...
   * @param xPixelsPerUnit the amount of pixels per one unit in the com.bleau.hibernatus.mob.achartengine.chart labels
   * @param minX the minimum value on the X axis in the com.bleau.hibernatus.mob.achartengine.chart
   * @param maxX the maximum value on the X axis in the com.bleau.hibernatus.mob.achartengine.chart
   */
   ...
   * @param bottom the bottom value of the labels area
   * @param yPixelsPerUnit the amount of pixels per one unit in the com.bleau.hibernatus.mob.achartengine.chart labels
   * @param minY the minimum value on the Y axis in the com.bleau.hibernatus.mob.achartengine.chart
   */
  ...
  /**
   * Returns if the com.bleau.hibernatus.mob.achartengine.chart should display the null values.
   * 
  ...
  /**
   * Returns if the com.bleau.hibernatus.mob.achartengine.chart should display the points as a certain shape.
   * 
   * @param renderer the series com.bleau.hibernatus.mob.achartengine.chart.renderer
   */
  ...
  /**
   * Returns the scatter com.bleau.hibernatus.mob.achartengine.chart to be used for drawing the data points.
   * 
   * @return the data points scatter com.bleau.hibernatus.mob.achartengine.chart
   */
