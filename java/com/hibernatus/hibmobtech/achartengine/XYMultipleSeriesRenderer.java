...
/**
 * Multiple XY series com.bleau.hibernatus.mob.achartengine.chart.renderer.
 */
public class XYMultipleSeriesRenderer extends DefaultRenderer {
  ...
  /** The current orientation of the com.bleau.hibernatus.mob.achartengine.chart. */
  ...
  /** A constant value for the bar com.bleau.hibernatus.mob.achartengine.chart items width. */
  ...
  /**
   * An enum for the XY com.bleau.hibernatus.mob.achartengine.chart orientation of the X axis.
   */
  ...
  /**
   * Returns the current orientation of the com.bleau.hibernatus.mob.achartengine.chart X axis.
   * 
   * @return the com.bleau.hibernatus.mob.achartengine.chart orientation
   */
  ...
  /**
   * Sets the current orientation of the com.bleau.hibernatus.mob.achartengine.chart X axis.
   * 
   * @param orientation the com.bleau.hibernatus.mob.achartengine.chart orientation
   */
   ...
   * Returns the title for the Y axis.
   * 
   * @param scale the com.bleau.hibernatus.mob.achartengine.chart.renderer scale
   * @return the Y axis title
   */
   ...
   * 
   * @param textSize the com.bleau.hibernatus.mob.achartengine.chart axis text size
   */
  ...
  /**
   * Returns the constant bar com.bleau.hibernatus.mob.achartengine.chart item width in pixels.
   * 
  ...
  /**
   * Sets the bar com.bleau.hibernatus.mob.achartengine.chart item constant width in pixels.
   * 
   ...
   * @param scale the com.bleau.hibernatus.mob.achartengine.chart.renderer index
   * 
