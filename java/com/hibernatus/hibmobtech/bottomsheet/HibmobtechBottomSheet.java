package com.hibernatus.hibmobtech.bottomsheet;

/**
 * Created by Eric on 25/12/2016.
 */
...
public class HibmobtechBottomSheet<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public HibmobtechBottomSheet(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                        (float) (mMaxOffset - top) / ((mMaxOffset - mMinOffset)));
    ...
    /**
     * A utility function to get the {@link HibmobtechBottomSheet} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link HibmobtechBottomSheet}.
     * @return The {@link HibmobtechBottomSheet} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> HibmobtechBottomSheet<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof HibmobtechBottomSheet)) {
            throw new IllegalArgumentException(
                    "The view is not associated with HibmobtechBottomSheet");
        }
        return (HibmobtechBottomSheet<V>) behavior;
    }
