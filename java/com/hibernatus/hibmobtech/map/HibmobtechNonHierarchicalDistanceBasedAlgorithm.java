...
public class HibmobtechNonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    public static final String TAG = HibmobtechNonHierarchicalDistanceBasedAlgorithm.class.getSimpleName();


    //public static int MAX_DISTANCE_AT_ZOOM = 100; // essentially 100 dp.
    public static int MAX_DISTANCE_AT_ZOOM = 12;
    ...
    private Bounds createBoundsFromSpan(Point p, double span) {
        Log.d(TAG, "createBoundsFromSpan: x=" + p.x + " y="+ p.y + " span=" + span);
