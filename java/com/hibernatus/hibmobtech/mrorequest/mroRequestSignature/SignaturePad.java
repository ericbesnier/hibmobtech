...
// c l a s s   S i g n a t u r e P a d
// -----------------------------------
public class SignaturePad extends View {
    //View activityObservable
    ...
    // C o n s t r u c t o r   S i g n a t u r e P a d
    // -----------------------------------------------
    public SignaturePad(Context context, AttributeSet attrs) {
        ...
        //Dirty rectangle to onUpdatedContent only the changed portion of the view
    ...
    public void setPenColorRes(int colorRes) {
        try {
            ...
            //HibmobtechApplication.getInstance().trackException(ex);
    ...
    private void resetDirtyRect(float eventX, float eventY) {
        ...
        // The mLastTouchX and mLastTouchY were updateCause when the ACTION_DOWN motion event occurred.
